...
void mode_default() {
  ...
  if (t5mins == 5 || t5mins == 55)     M_FIVE();        // 5 ou moins 5
  else if (t5mins == 10 || t5mins == 50)    M_TEN();        // 10 ou moins 10
  else if (t5mins == 15)    M_QUARTER_PLUS();    // et quart
  else if (t5mins == 45)    M_QUARTER_MINUS();    // et quart
  else if (t5mins == 20 || t5mins == 40)    M_TWENTY();  // 20 ou moins 20
  else if (t5mins == 25 || t5mins == 35)    M_TWENTYFIVE();  // 25 ou moins 25
  else if (t5mins == 30)    M_HALF();  // et demie
...
void W_ITIS() {
  LC1.setRow(0,0,B11011100);  // IL EST
}
